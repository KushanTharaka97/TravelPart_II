...
public class CountryNoteProvider extends ContentProvider {

    /** Tag for the log messages */
    public static final String LOG_TAG = CountryNoteProvider.class.getSimpleName();
    ...
    static {
        ...
        sUriMatcher.addURI(CountryContract.CONTENT_AUTHORITY, CountryContract.PATH_COUNTRIES_NOTE, COUNTRIES);
        sUriMatcher.addURI(CountryContract.CONTENT_AUTHORITY,CountryContract.PATH_COUNTRIES_NOTE+ "/#" ,COUNTRY_ID);
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match){
            ...
            case COUNTRIES:
                cursor = database.query(CountryContract.NOTE_TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
                break;

            //if uri match with the certain id
            case COUNTRY_ID:
                selection = CountryContract._Note_ID+"=?";
    ...
    private Uri insertCountries(Uri uri, ContentValues values){
        ...
        long id = databaseForInsertion.insert(CountryContract.NOTE_TABLE_NAME,null,values);
        if(id == -1){
