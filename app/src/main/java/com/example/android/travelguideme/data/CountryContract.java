...
public class CountryContract  {
     ...
     */
        ...
        public static final Uri CONTENT_NOTE_URI = Uri.withAppendedPath(BASE_CONTENT_URI,PATH_COUNTRIES_NOTE);
    }
    ...
    //creating new table for note related things
    //creating our second table
    public static final String NOTE_TABLE_NAME = "note";

    public static final String _Note_ID = BaseColumns._ID;

    public static final String COUNTRY_NAME = "country_name";

    public static final String NOTE_IN_NOTE ="_note";

    public static final String PATH_COUNTRIES_NOTE = CountryContract.NOTE_TABLE_NAME;
