...
public class CountryDetails extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         note_view = findViewById(R.id.yourMemo);
    ...
    private void insertData(Cursor cursor){
        ...
        String Name = note_view.getText().toString().trim();
        //SQLiteDatabase db  = mDbHelper.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(CountryContract.NOTE_IN_NOTE, Name);
       // values.put(CountryContract.COUNTRY_NAME, cursor.getString(InsertCountryData.COLUMN_COUNTRY_NAME));
    }
}
