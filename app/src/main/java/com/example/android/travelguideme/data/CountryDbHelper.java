...
public class CountryDbHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        try{
            ...
            //creating note table
            String SQL_CREATE_NOTE_TABLE = " CREATE TABLE "+ CountryContract.NOTE_TABLE_NAME +"("
                    + CountryContract._Note_ID+  " INTEGER PRIMARY KEY AUTOINCREMENT, "
                    +CountryContract.COUNTRY_NAME+"TEXT DEFAULT null,"
                    +CountryContract.NOTE_IN_NOTE+"TEXT DEFAULT null);";
    ...
    //insert data function -update not in use
